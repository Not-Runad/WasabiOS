...
pub const BIT_FLAGS_INTGATE: u8 = 0b0000_1110_u8;
pub const BIT_FLAGS_PRESENT: u8 = 0b1000_0000_u8;
pub const BIT_FLAGS_DPL0: u8 = 0 << 5;
pub const BIT_FLAGS_DPL3: u8 = 3 << 5;
pub const BIT_TYPE_DATA: u64 = 0b10_u64 << 43;
pub const BIT_TYPE_CODE: u64 = 0b11_u64 << 43;
pub const BIT_PRESENT: u64 = 1_u64 << 47;
pub const BIT_CS_LONG_MODE: u64 = 1_u64 << 53;
pub const BIT_CS_READABLE: u64 = 1_u64 << 53;
pub const BIT_DS_WRITABLE: u64 = 1_u64 << 41;
pub const BIT_DPL0: u64 = 0_u64 << 45;
pub const BIT_DPL3: u64 = 3_u64 << 45;
...
impl TaskStateSegment64 {
    ...
    unsafe fn alloc_interrupt_stack() -> u64 {
        ...
        let stack = Box::new([0_u8; HANDLER_STACK_SIZE]);
...
/// # Safety
/// Writing to CR3 can causes any exceptions
/// so it is programmer's responsibility to setup correct page tables.
#[no_mangle]
...
/// # Safety
/// Anything can happen if the given selector is invald
...
/// # Safety
/// Anything can happen if the CS given is invald
